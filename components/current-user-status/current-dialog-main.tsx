...
function DialogContentMain({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="!rounded text-gray-300 bg-black">
        <DialogHeader className="text-[12px] font-bold">
          ...
          <InputField>
            <Input
              ...
              className="!rounded font-thin placeholder:text-black"
        ...
        <DialogDescription>
          ...
          <div className=" flex w-full justify-end">
            <Button onClick={() => setOpen((prev) => !prev)} className="mr-2">
              Cancel
            </Button>
            <Button
              onClick={() => {
